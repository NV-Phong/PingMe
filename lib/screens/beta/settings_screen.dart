        ...
        child: Column(
          children: [
            ...
            ProfileMenu(
              ...
              press: () => {}, // Handle action for "My Account"
            ),
            ProfileMenu(
              text: "Notifications",
              icon: "assets/icons/Bell.svg",
              press: () {}, // Handle action for "Notifications"
            ),
            ProfileMenu(
              text: "Settings",
              icon: "assets/icons/Settings.svg",
              press: () {}, // Handle action for "Settings"
            ),
            ProfileMenu(
              text: "Help Center",
              icon: "assets/icons/Question mark.svg",
              press: () {}, // Handle action for "Help Center"
            ),
            ProfileMenu(
              text: "Log Out",
              icon: "assets/icons/Log out.svg",
              press: () => _logout(context), // Use logout functionality here
            ),
          ],
        ),
      ),
